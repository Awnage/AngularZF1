 ...
 * @license    http://opensource.org/licenses/bsd-license.php     New BSD License
 */
class AngularZF1_Angular_View_Helper_AngularBootstrapCalendar extends Zend_View_Helper_Abstract
{
   ...
   /**
     ...
     * @return void
     */
    public function angularBootstrapCalendar()
    {
        $plugin = $this->_container->getPlugin('BootstrapCalendar');
        if ($plugin) {
