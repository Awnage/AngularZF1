 ...
 * @license    http://opensource.org/licenses/bsd-license.php     New BSD License
 */
class AngularZF1_Angular_View_Helper_Angular extends Zend_View_Helper_Abstract
{
    /**
   ...
   /**
    ...
    public function __call($method, $args)
    {
        if (!method_exists($this->_container, $method)) {
            ...
            throw new Zend_View_Exception(sprintf('Invalid method "%s" called on Angular view helper', $method));
        }
    ...
    /**
     * Disable noConflict Mode of Angular if this was previously enabled.
     *
     * @return void
     */
    ...
    /**
     * Return current status of the Angular no Conflict Mode
     *
     * @return Boolean
     */
    ...
    /**
     * Return current Angular handler based on noConflict mode settings.
     *
     * @return String
     */
    public static function getAngularHandler()
    {
