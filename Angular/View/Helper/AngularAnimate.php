 ...
 * @license    http://opensource.org/licenses/bsd-license.php     New BSD License
 */
class AngularZF1_Angular_View_Helper_AngularAnimate extends Zend_View_Helper_Abstract
{
   ...
   /**
     ...
     * @return void
     */
    public function angularAnimate()
    {
        $plugin = $this->_container->getPlugin('Animate');
        if ($plugin) {
