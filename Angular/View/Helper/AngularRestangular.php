 ...
 * @license    http://opensource.org/licenses/bsd-license.php     New BSD License
 */
class AngularZF1_Angular_View_Helper_AngularRestangular extends Zend_View_Helper_Abstract
{
   ...
   /**
     ...
     * @return void
     */
    public function angularRestangular()
    {
        $plugin = $this->_container->getPlugin('Restangular');
        if ($plugin) {
