 ...
 * @license    http://opensource.org/licenses/bsd-license.php     New BSD License
 */
class AngularZF1_Application_Resource_Plugin_Restangular
    implements AngularZF1_Application_Resource_Plugin_Interface
{
     ...
     * @const string
     */
    const CDN_SUBFOLDER = 'restangular/';
     ...
     */
    const MIN_PATH = '/restangular.min.js';
